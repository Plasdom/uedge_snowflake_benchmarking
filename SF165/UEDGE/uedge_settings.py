...
bbb.GridFileName = "../gridfiles/gridue_SF165_R0_10000"
bbb.mhdgeo = 1
com.geometry[0] = "snowflake165     "
com.isudsym = 0
bbb.gengrid = 0
bbb.newgeo = 1
com.nxpt = 2
...
bbb.lyni[1] = 0.04  # iy=ny+1 density radial scale length (m)
bbb.lyni[0] = 0.04  # iy=0 density radial scale length
...
bbb.lyte = 0.05  # 0.02	# scale length for Te bc
bbb.lyti = 0.05  # 0.02	# scale length for Ti bc
