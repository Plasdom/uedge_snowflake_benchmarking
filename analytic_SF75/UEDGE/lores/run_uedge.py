...
"""============  Apply settings  ==============="""
us.set_geometry(
    gridfile="/Users/power8/Documents/04_mastu_modelling/2024_MASTU_shots/works_in_progress/analytic_SFs/analytic_SF75/gridfiles/gridue_44x18_R0_10000",
...
# hdf5_restore("wip_R0_10000.hdf5")
hdf5_restore("wip_R0_10000_phionly.hdf5")
bbb.exmain()
# rundt()

c = UeRun()
c.continuation_solve(
    var={
        "difutm": {"target": 10},
        "travis": {"target": 10},
        "cfyef": {"target": 0.2},
