...
bbb.GridFileName = "../gridfiles/gridue_SF135_R0_10000_lores"
bbb.mhdgeo = 1
com.geometry[0] = "snowflake135    "
com.isudsym = 0
bbb.gengrid = 0
bbb.newgeo = 1
com.nxpt = 2
...
bbb.ncore[0] = 2.3e19  # hydrogen ion density on core
...
bbb.pcoree = 10000 * 2 * 0.5e6  # core elec power if iflcore=1
bbb.pcorei = 10000 * 2 * 0.5e6  # core ion  power if iflcore=1
...
bbb.lyni[1] = 0.01  # iy=ny+1 density radial scale length (m)
bbb.lyni[0] = 0.01  # iy=0 density radial scale length
...
bbb.lyte = 0.02  # 0.02	# scale length for Te bc
bbb.lyti = 0.02  # 0.02	# scale length for Ti bc
...
bbb.recycp = 1
bbb.recycw = 1
bbb.recycw[0] = 1.0  # recycling coeff. at wall
